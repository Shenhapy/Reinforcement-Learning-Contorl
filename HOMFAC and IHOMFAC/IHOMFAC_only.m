...
title('Comparison of Desired Input (y) and Improved High-Order MFAC');
xlabel('Time');
ylabel('Tracking Performance');
legend('y(t)', 'Improved High-Order MFAC');
hold off;
...
hold on;
plot(1:T+1, y_improved, 'm:', 'LineWidth', 1.5);
title('The local tracking performance t: 785-820 of Desired Input (y) and Improved High-Order MFAC');
xlabel('Time');
ylabel('Tracking Performance');
legend('y(t)', 'Improved High-Order MFAC');
...
hold on;
plot(1:T+1, y_improved, 'm:', 'LineWidth', 1.5);
title('The local tracking performance t: 920-1000 of Desired Input (y) and Improved High-Order MFAC');
xlabel('Time');
ylabel('Tracking Performance');
legend('y(t)', 'Improved High-Order MFAC');
xlim([zoom_start, zoom_end]); % Set the x-axis limits
...
title('PPD estimate value for Improved High-Order MFAC');
xlabel('Time');
ylabel('PPD Estimate Value');
legend('Improved High-Order MFAC');

% Plot y and y_improved
figure;
plot(1:T, u_improved, 'r:', 'LineWidth', 1.5);
title('Control Input for Improved High-Order MFAC');
xlabel('Time');

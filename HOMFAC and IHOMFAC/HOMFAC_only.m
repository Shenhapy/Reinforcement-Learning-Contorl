...
title('Comparison of Desired Input (y) and Using High-Order MFAC');
xlabel('Time');
ylabel('Tracking Performance');
legend('y(t)', 'High-Order MFAC');
hold off;
...
hold on;
plot(1:T+1, y_improved, 'm:', 'LineWidth', 1.5);
title('The local tracking performance t: 785-820 of Desired Input (y) and Using High-Order MFAC');
xlabel('Time');
ylabel('Tracking Performance');
legend('y(t)', 'High-Order MFAC');
...
title('The local tracking performance t: 920-1000 of Desired Input (y)and Using High-Order MFAC');
xlabel('Time');
ylabel('Tracking Performance');
legend('y(t)', 'High-Order MFAC');
xlim([zoom_start, zoom_end]); % Set the x-axis limits
